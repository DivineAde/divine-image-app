<div align="center">
  ...
  <h3 align="center">An AI SaaS Image Studio Platform</h3>
...
```bash
git clone https://github.com/DivineAde/divine-image-app.git
cd divine-image-app
```
...
Public Assets used in the project can be found in the repo assets folder 
